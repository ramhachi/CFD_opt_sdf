"""PQ0.2 smoke: real OpenFOAM oracle through the nonlinear loop.
...
EVIDENCE = ROOT / "docs/evidence/pq0_2_openfoam_oracle_smoke_2026_09.json"
...
def main() -> None:
    ...
    base_volume = float(rho[active].mean())
    volume_limit = base_volume + 0.005
    print(f"base projected volume {base_volume:.6f}, V_max {volume_limit:.6f}")
    ...
    evidence = {
        "artifact_id": "pq0_2_openfoam_oracle_smoke_2026_09",
        "evidence_class": "capability_execution",
        "issue": "PQ0.2 real oracle smoke",
        "reduced_problem": {
            "objective": "minimize -C_DF (maximize downforce)",
            "volume_limit": volume_limit,
            "base_projected_volume": base_volume,
