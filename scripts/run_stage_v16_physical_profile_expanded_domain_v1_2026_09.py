...
import register_stage_v16_physical_profile_expanded_domain_v1_2026_09 as registration  # noqa: E402
...
OUTCOME = ROOT / "docs/evidence/stage_v_v16_physical_profile_expanded_domain_v1_2026_09.json"
...
def _identity_gate(case_dir: Path, run_manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    checks = {
        ...
        "expanded_problem_id": metadata.get("problem_id") == "stage_sv_v2_expanded_domain_v1",
