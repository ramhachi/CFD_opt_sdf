"""PQ3.3b preflight v5: carry objective-accepted designs across levels.
...
noise measurement. It does not start the long optimization campaign.
"""
...
OUT = ROOT / "work" / "pq3_3b_preflight_v5"
TEMPLATE_SOURCE = ROOT / "work" / "pq0_2_smoke" / "template_trial"
EVIDENCE = ROOT / "docs" / "evidence" / "pq3_3b_preflight_v5_2026_09.json"
NOISE_EVIDENCE = ROOT / "docs" / "evidence" / "pq3_3b_noise_calibration_v2_2026_09.json"
SHAPE = (60, 32, 24)
SPACING = 0.05
...
def main():
    if EVIDENCE.exists() or NOISE_EVIDENCE.exists() or OUT.exists():
        raise SystemExit("preflight v5 artifacts already exist; refusing to overwrite")
    ...
    for index, spec_level in enumerate(LEVELS):
        ...
        # The policy returns the full per-alpha ledger even when all fail.
        ...
        if phase2.get("successful"):
            ...
            if index == 2:
                # A b=16 candidate must beat the solver noise for a v5 pass.
                b16_improved = False
