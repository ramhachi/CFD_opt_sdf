...
EVIDENCE = ROOT / "docs/evidence/pq3_first_closed_loop_v5_2026_09.json"
SEED_FLOOR = 1e-3
VOLUME_MARGIN = 0.002
...
def main() -> None:
    ...
    body = (rho.reshape((60, 32, 24), order="F") > 0.05)
    ...
    result = run_stage_t_loop(
        spec=loop_spec,
        oracle=oracle,
        backend=ProjectedGradientBackend(bound_margin=1e-4),
        initial_rho=seed,
    ...
    evidence = {
        "artifact_id": "pq3_first_closed_loop_v5_2026_09",
        ...
        "reduced_problem": {
            ...
            "seed_rule": "max(rho_canonical, 1e-3) on the 2-cell dilation of the body mask",
